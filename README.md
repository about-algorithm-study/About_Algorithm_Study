...
# 예시
8월3주차/0820/BOJ_27433/BOJ_27433_김강연.py
8월3주차/0820/BOJ_10870/BOJ_10870_신재혁.py
8월3주차/0820/PRO_12345/PRO_12345_오창민.py
```
...
# 3. 해당 문제 폴더에 파일 생성
cd BOJ_27433
# 여기에 BOJ_27433_본인이름.py 파일 작성

cd ../BOJ_10870
# 여기에 BOJ_10870_본인이름.py 파일 작성
```
...
git add .  # 모든 변경사항 추가
# 또는 특정 파일만
git add 8월3주차/0820/BOJ_27433/BOJ_27433_본인이름.py
```
